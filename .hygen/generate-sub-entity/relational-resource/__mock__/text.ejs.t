---
to: "<%= isAddTestCase && !h.exists(`src/${h.inflection.transform(parent, ['pluralize','underscore','dasherize'])}/__mock__/${h.inflection.transform(parent, ['underscore','dasherize'])}.mock.ts`) ? `src/${h.inflection.transform(parent, ['pluralize','underscore','dasherize'])}/__mock__/${h.inflection.transform(parent, ['underscore','dasherize'])}.mock.ts` : null %>"
---
